    ...
    return (
        <nav
            className={`fixed w-full top-0 z-50 transition-all duration-500 ${isOpen
                ? "bg-[#030014]/95 backdrop-blur-2xl border-b border-white/10 shadow-[0_12px_40px_rgba(3,0,20,0.55)]"
                : scrolled
                    ? "bg-[#030014]/60 backdrop-blur-2xl border-b border-white/10 shadow-[0_12px_40px_rgba(3,0,20,0.45)]"
                    : "bg-transparent"
                }`}
        >
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex-shrink-0">
                        <a
                            ...
                            className="text-2xl font-bold tracking-wide bg-gradient-to-r from-[#a855f7] via-[#7c7cff] to-[#6366f1] bg-clip-text text-transparent"
                        >
                            NIKESH SAHOO
                        </a>
                    </div>
            ...
            {/* Mobile Menu Overlay */}
            <div
                className={`md:hidden fixed inset-0 bg-[#030014] transition-all duration-300 ease-in-out ${isOpen
